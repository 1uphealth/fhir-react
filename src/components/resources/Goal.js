          ...
          <div className="container">
            ...
            <div className="row">
              {typeof _.get(this.props.fhirResource, 'category') === 'undefined'
                ? ''
                : _.get(this.props.fhirResource, 'category').map(function(
                    category,
                  ) {
                    return (_.get(category, 'coding') || []).map(function(
                      coding,
                    ) {
                      return (
                        <div>
            ...
            <br />
            <div className="row">
              {typeof _.get(this.props.fhirResource, 'author') ===
              'undefined' ? (
                ''
              ) : (
                <span>
            ...
            {typeof _.get(this.props.fhirResource, 'author') === 'undefined' ? (
              ...
              <div className="row">
                <div className="col-12 pl-0 pr-0">
                  <Reference
                    fhirData={_.get(this.props.fhirResource, 'author')}
                  />
                </div>
              </div>
            )}
