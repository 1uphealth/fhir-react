          ...
          <div className='container pl-0 pr-0'>
            <div className='row pl-0 pr-0'>
              <div className='col-12'>
                <Coding fhirData={_.get(this.props.fhirResource, 'substance.coding[0]')} />
              </div>
            </div>
            <div className='row pl-0 pr-0'>
              <div className='col-12'>
              ...
              <div className='col-12'>
                { typeof _.get(this.props.fhirResource,'reaction') === 'undefined' ? '' :
                  (_.get(this.props.fhirResource,'reaction').map(function(reaction){
                    return (_.get(reaction,'manifestation') || []).map(function(manifestation){
                      return (_.get(manifestation,'coding') || []).map(function(coding){
                        return (<div>
                          <Coding fhirData={coding} />
                          {typeof _.get(reaction,'severity') === 'undefined' ? '' : (
                            <span>
