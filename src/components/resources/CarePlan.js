            ...
            <div className="row">
              {
                ...
                (
                  <span>
                    <small className='text-uppercase text-muted'><strong>Category</strong></small>
                  </span>
                )
              }
            </div>
            ...
            <div className="row">
              {
                ...
                (
                  <span>
                    <small className='text-uppercase text-muted'><strong>Goal</strong></small>
                  </span>
                )
              }
            </div>
            { typeof _.get(this.props.fhirResource,'goal') === 'undefined' ? '' :
              ((_.get(this.props.fhirResource,'goal') || []).map(function(goal){
                return <div className="row"><div className="col-12 pl-0 pr-0"><Reference fhirData={goal}/></div></div>
              }))
            }
            <br />
            <div className="row">
            ...
            <div className="row">
              {
                ...
                (
                  <span>
                    <small className='text-uppercase text-muted'><strong>Activity</strong></small>
                  </span>
                )
              }
            </div>
            { typeof _.get(this.props.fhirResource,'activity') === 'undefined' ? '' :
              ((_.get(this.props.fhirResource,'activity') || []).map(function(activity){
                return <div className="row"><div className="col-12 pl-0 pr-0"><CarePlanActivity fhirData={activity}/></div></div>
              }))
            }
          </div>
        </ResourceContainer>
